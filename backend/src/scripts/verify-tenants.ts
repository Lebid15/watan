...
async function run() {
  ...
  const summary = { issues, counts: { orphanUsers: orphanUsers.length, tenantsNoPrimary: tenantsNoPrimary.length, multiPrimary: multiPrimary.length, tenantsNoDomain: tenantsNoDomain.length } };
