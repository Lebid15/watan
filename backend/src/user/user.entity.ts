...
export class User {
  ...
  // 🔹 سيتم جعل هذا الحقل NOT NULL لكل المستخدمين العاديين عبر Migration تصحيحية.
  // الاستثناء الوحيد المحتمل: أدوار منصة عليا (instance_owner) إن بقيت نحتاج تحويلها إلى تينانت خاص.
  // مؤقتاً يبقى nullable لتفادي كسر التشغيل قبل تشغيل migration.
