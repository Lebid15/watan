...
SECRET_KEY = 'django-insecure-$kzzc)c921j4$se4@)(drilrn-x14tt=3)5gd0jlc5!%^ppjm_'
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # ⬅️ أولاً
    'django.middleware.security.SecurityMiddleware',
    'django.contrib.sessions.middleware.SessionMiddleware',
    'django.middleware.common.CommonMiddleware',  # ⬅️ بعده
